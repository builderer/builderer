    ...
    def _write_solution(self, file: TextIOWrapper):
        ...
        file.writelines(
            [
                ...
                f"Microsoft Visual Studio Solution File, Format Version {self.version.solution_format_version}\n",
                f"VisualStudioVersion = {self.version.visual_studio_version}\n",
                f"MinimumVisualStudioVersion = {self.version.minimum_visual_studio_version}\n",
            ]
        )
